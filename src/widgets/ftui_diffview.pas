...
begin
  ...
  Result.AddedStyle := TStyle.Default.WithFg(clGreen);
  Result.RemovedStyle := TStyle.Default.WithFg(clRed);
  Result.HeaderStyle := TStyle.Default.WithFg(clCyan).WithModifier([mbBold]);
